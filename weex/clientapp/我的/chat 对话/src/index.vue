        ...
        methods: {
            ...
            isRead(aId){
                ...
                post.fetch({
                    ...
                    type: 'json',
                    body: param,
                    url: 'https://www.aftdc.com/userapp/Order/isRead',
            ...
            sendUserMessage (chatData) {
                if (chatData) {
                    ...
                    post.fetch({
                        ...
                        type: 'json',
                        body: param,
                        url: 'https://www.aftdc.com/userapp/Order/sendChat',
                        headers: {"Content-Type": "application/x-www-form-urlencoded"},
                    }, function (res) {
                        if (res.data.res ===1){
                            chatData.from = 'user';
            ...
            viewappear() {
                ...
                if (event.find("localImg")) {
                    ...
                    var articleImg = 'user/'+event.find('userId')+'/chatImg/'+Date.parse(new Date())+ houzui;
