    ...
    <div class="socialBinding">
        <div class="minibar">
            ...
            >
                ...
                <text :style="GLOBAL.headerCenter"  slot="middle">账号注销验证</text>
        ...
        <div class=" enterButton" :style="{opacity:code.length==6 && phone.length==11?1:'0.5'}">
            <wxc-button class="okButton" text="注销" :textStyle="GLOBAL.buttonText" :btnStyle="GLOBAL.defaultButton"
            ...
            next(){//下一步
                ...
                if(that.code.length==6 && that.phone.length==11){
                    ...
                    post.fetch({
                        ...
                        url: 'https://www.aftdc.com/userapp/Mine/logoutAccount',
                    }, function (res) {
