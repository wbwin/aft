    ...
    <div class="wrapper">
        <div class="minibar">
            ...
            >
                ...
                <text :style="GLOBAL.headerCenter"  slot="middle">城市合伙人</text>
                <text :style="GLOBAL.headerRight"  slot="right"></text>
            </wxc-minibar>
        </div>
        <div class="mercgantEntryTop">
            <image class="mercgantEntryImg" src="https://image.aftdc.com/images/packageA/hhr.jpg"></image>
        </div>
        <div class="panel">
            <div class="from">
                ...
                <div class="yzmBox">
                    ...
                    <button class="yzmBut" v-if="count==90" @click="getYzm">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            enter(){
                var param=''
                var url='http://assets/partnersMessage.js'
