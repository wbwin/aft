    ...
    <div class="wrapper" >
        <div class="minibar">
            <wxc-minibar
                ...
                <text :style="GLOBAL.headerCenter" slot="middle">隐私政策</text>
        ...
        <div class="content">
            <div class="mb30">
                <text class="headerText dcolor bold" :style="{fontSize:GLOBAL.biggerFS}">隐私政策</text>
                <text class="lineHeight46 mt24 dcolor" :style="{fontSize:GLOBAL.biggerFS}" v-for="(item,index) in privacyPolicyStatementText" :class="[ index>0&&index<11?'bold':'']">{{item}}</text>
            </div>
...
<script>
    ...
    export default {
        data() {
            return {
                privacyPolicyStatementText: [
                    '       阿凡提(以下或称“我们”)注重保护用户个人信息及个人隐私。本隐私政策包含我们收集、处理、存储、使用、共享、转让、公开披露和保护用户(“您”)个人信息(以下或称“信息”)的有关条款。',
                    '本政策将帮助您了解以下内容:',
                    '1、我们如何收集和使用您的个人信息;',
                    '2、我们如何使用Cookie和同类技术;',
                    ...
                    '       我们致力于维持您对我们的信任，恪守以下原则，保护您的个人信息:权责一致原则、目的明确原则、选择同意原则、最少够用原则、确保安全原则、主体参与原则、公开透明原则等。同时，我们承诺，我们将按业界成熟的安全标准，采取相应的安全保护措施来保护您的个人信息。请您在使用我们的服务前，仔细阅读并了解本《隐私政策》，以帮助您了解维护自己隐私权的方式。如您对本隐私政策有任何疑问，您可以通过我们公布的联系方式与我们联系。',
                ...
                privacyPolicyText: [
                    {
                        title: '一、适用范围',
                        paragraph: [
                            '       本隐私政策适用于阿凡提平台提供的所有服务(以下称“服务”或“我们的服务”)，您访问阿凡提平台及/或登陆相关客户端使用阿凡提提供的服务，均适用本隐私政策。',
                            '       本政策所称“阿凡提平台”包括但不限于阿凡提网(域名为www.aftdc.com)等网站及客户端、以及相关微信公众号平台。本政策所称“阿凡提”是阿凡提平台经营者北京三快科技有限公司及现有和/或未来设立的相关关联公司的单称或合称。',
                            '       本政策最近更新日期:2018年2月6日。',
                    ...
                    },
                    {
                        ...
                        paragraph: [
                            ...
                            '       您在阿凡提平台发布点评内容过程中所提交的任何文字、照片、视频等各种形式的信息，也可能会包含或者关联到您的个人信息。',
                            ...
                            '(2)您的位置信息。当您开启设备定位功能，下载或使用我们、关联方及合作伙伴开发的应用程序(例如阿凡提APP、大众点评网APP)，或访问移动网页使用我们服务时，我们可能会读取您的位置(大多数移动设备将允许您关闭定位服务，具体方法建议您联系您的移动设备的服务商或生产商)。',
                    ...
                    },
                    {
                        title: '四、您共享的信息',
                        paragraph: [
                            '       您可以通过我们的服务建立联系和相互分享。当您通过我们的服务创建交流、交易或分享时，您可以允许阿凡提访问您的电脑、手机或其他第三方社交平台的通讯录，从而使您通讯录中同样通过我们的服务开通分享功能的联系人，能够看到您在阿凡提上的交易信息、评价以及其他的分享内容。您还可以通过我们的服务邀请尚未开通分享功能的联系人开通该功能，从而使其可以看到您在阿凡提上的交易信息、评价以及其他的分享内容。',
                            '       在使用阿凡提平台服务进行交易时，您不可避免的要向交易对方或潜在的交易对方披露自己的个人信息，如联络方式或者邮政地址。请您妥善保护自己的个人信息，仅在必要的情形下向他人提供。如您发现自己的个人信息泄密，尤其是您的账户或密码发生泄露，请您立即联络阿凡提，以便阿凡提采取相应措施。',
                            '       公开信息是指您自愿公开分享的任何信息。任何人都可以在使用和未使用阿凡提期间查看或访问这些信息。',
                            '       为使用阿凡提服务，可能存在您必须公开分享的信息。例如为构建诚信交易环境，您的信用评价信息需要被公开分享。若您是产品或服务提供方/出售方，您应当根据适用的法律法规和阿凡提规则的要求，公开分享经营信息。',
                    ...
                    },
                    {
                        ...
                        paragraph: [
                            ...
                            '3、出于实现“我们对您个人信息的使用”部分所述目的，或为履行我们在《阿凡提网用户协议》或本隐私政策中的义务和行使我们的权利，向我们的关联方、合作伙伴或代表我们履行某项职能的第三方(例如代表我们发出推送通知的通讯服务商、处理银行卡的支付机构等)分享您的个人信息。',
                    ...
                    },
                    {
                        ...
                        paragraph: [
                            ...
                            '       我们将定期更新并公开安全风险、个人信息安全影响评估等报告的有关内容。您可通过进入阿凡提网站首页相关模块或联系我们的客服获取。',
                    ...
                    {
                        title: '八、如何访问和更新您的个人信息',
                        paragraph: [
                            '       您对您的个人信息您享有以下权利:',
                            '(一)您有权访问您的个人信息，法律法规规定的例外情况除外。如果您想行使数据访问权，可以通过以下方式自行访问:',
                            '       账户信息——如果您希望访问或编辑您的账户中的个人资料信息和支付信息、更改您的密码、添加安全信息或关闭您的账户等，您可以通过访问阿凡提网页执行此类操作。',
                            '       搜索信息——您可以在阿凡提官网及相关网站中访问或清除您的搜索历史记录、查看和修改兴趣以及管理其他数据。',
                            '       如果您无法通过上述链接访问这些个人信息，您可以随时使用我们的Web表单联系，或联系我们的客服。我们将在30天内回复您的访问请求。',
                            '(二)更正您的个人信息;',
                            '(三)删除您的个人信息;',
                            '(四)改变您授权同意的范围。以上信息您均可以通过阿凡提网站主页进行访问和更新。如果您认为阿凡提存在违反法律的规定收集、使用您个人信息的情形，您可以通过阿凡提客服与我们取得联系。'
                        ]
                    },
                    {
                        title: '九、如何使用Cookie及网络Beacon',
                        paragraph: [
                            '1、Cookie的使用',
                            ...
                            '       您有权接受或拒绝Cookie。大多数浏览器会自动接受Cookie，但您通常可根据自己的需要来修改浏览器的设置以拒绝Cookie。目前，主要互联网标准组织尚未设立相关政策来规定网站应如何应对此类请求。如果您的浏览器启用了DoNotTrack，那么我们的所有网站都会尊重您的选择。但您可能无法完全体验所访问的我们网站或某些服务的全部功能。',
                            '2、网络Beacon的使用',
                            '       我们网页上常会包含一些电子图象(称为"单像素"GIF文件或"网络beacon")，它们可以帮助网站计算浏览网页的用户或访问某些cookie。我们使用网络beacon的方式有:',
                            '(1)我们通过在我们网站上使用网络beacon，计算用户访问数量，并通过访问cookie辨认注册用户。',
                            '(2)我们通过得到的cookie信息，可以在我们网站提供个性化服务。'
                        ]
                    },
                    {
                        title: '十、如何保护未成年人的个人信息',
                        paragraph: [
                            ...
                            '       我们根据适用法律的规定保护未成年人的个人信息。尽管当地法律和习俗对儿童的定义不同，但我们将不满14周岁的任何人均视为儿童。'
                        ]
                    },
                    {
                        title: '十一、通知和修订',
