...
<template>
    <div class="wrapper">
        ...
        <scroller class="scroller" offset-accuracy="10" @scroll="scrollHandler" >
            <div class="masking" v-for="(item,index) in collectData" @click="goToUserArticle(index)" @touchstart="ontouchstart(item.id,index)" @touchend="ontouchend">
                <div class="masks">
                    <div>
        ...
        <wxc-mask height="322"
            ...
            <div class="mask" @click.stop="">
                ...
                <text class="maskContent">确定删除此转发消息？</text>
...
<script>
    ...
    export default {
        ...
        created:function() {
            ...
            // this.token = '$2y$10$3c5IpFiwliI0jDEe9xeka.0ugP5Qw0puk6XPSYp1EGyXuMZdW9RtO';
            // this.imei = '2839feb68b61076477af18642a9b4daeeca9f724';
            ...
            post.fetch({
                ...
                if (e.data.res === -2) {
                    ...
                    var collectData = e.data.data;
                    that.page += e.data.page;
                    if (collectData.length !== 10) {
                        that.loadingingType = 0;
                    }
                    that.collectData = that.collectData.concat(collectData);
        ...
        methods:{
            ...
            goToUserArticle(index) {
                if(this.longPress === false){
                    var that = this;
                    var userId = that.collectData[index].userId;
            ...
            commentDelect(){
                ...
                post.fetch({
                    ...
                    if(e.data.res === 1) {
                        that.collectData.splice(that.delIndex,1)
