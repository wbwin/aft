    ...
    <div class="wrapper">
        <div class="minibar">
            ...
            >
                ...
                <text :style="GLOBAL.headerCenter"  slot="middle">商品评价</text>
                <!--<text :style="GLOBAL.headerRight"  slot="right">帮助</text>-->
            </wxc-minibar>
        </div>
        <scroller class="scroller" offset-accuracy="10" @scroll="scrollHandler">
            <div class="masking" v-for="(item, index) in goodsData"  @touchstart="ontouchstart(item.id,index)" @touchend="ontouchend">
                <div class="masks">
                    <div>
                    ...
                    <div class="right">
                        ...
                        <div>
                            ...
                            <text class="action" :style="{fontSize:GLOBAL.bigFS,color:GLOBAL.dColor}">{{item.goodsName}}</text>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <wxc-mask height="322"
            ...
            <div class="mask" @click.stop="">
                ...
                <text class="maskContent">确定删除此商品评价消息？</text>
        ...
        created:function() {
            ...
            post.fetch({
                ...
                if (e.data.res === -2) {
                    ...
                    var goodsData = e.data.data;
                    that.page += e.data.page;
                    if (goodsData.length !== 10) {
                        that.loadingingType = 0;
                    }
                    that.goodsData = that.goodsData.concat(goodsData);
        ...
        methods:{
            ...
            commentDelect(){
                ...
                post.fetch({
                    ...
                    if(e.data.res === 1) {
                        that.goodsData.splice(that.delIndex,1)
