    ...
    <div class="wrapper">
        <div class="minibar">
            ...
            >
                ...
                <text :style="GLOBAL.headerCenter"  slot="middle">赞</text>
                <!--<text :style="GLOBAL.headerRight"  slot="right">帮助</text>-->
            </wxc-minibar>
        </div>
        <scroller class="scroller" offset-accuracy="10" @scroll="scrollHandler">
            <div class="masking" v-for="(item,index) in zanData" @click="goToUserArticle(index)" @touchstart="ontouchstart(item.id,index)" @touchend="ontouchend">
                <div class="masks">
                    <div>
                    ...
                    <div class="right">
                        ...
                        <div style="margin-top: 25px;flex-direction: row;align-items: center">
                            <image class="good" src="https://image.aftdc.com/images/nozhan.png"></image>
                ...
                <!--<div>-->
                <!--<image class="article" src="https://image.aftdc.com/appBimg/ic_app_logo.jpg"></image>-->
                <!--</div>-->
            </div>
        ...
        <wxc-mask height="322"
            ...
            <div class="mask" @click.stop="">
                ...
                <text class="maskContent">确定删除此赞消息？</text>
    ...
    export default {
        ...
        created: function() {
            ...
            post.fetch({
                ...
                if (e.data.res === -2) {
                    ...
                    var zanData = e.data.data;
                    that.page += e.data.page;
                    if (zanData.length !== 10) {
                        that.loadingingType = 0;
                    }
                    that.zanData = that.zanData.concat(zanData);
        ...
        methods:{
            ...
            goToUserArticle(index) {
                if(!this.longPress) {
                    var that = this;
                    var userId = that.zanData[index].userId;
            ...
            commentDelect(){
                ...
                post.fetch({
                    ...
                    if(e.data.res === 1) {
                        that.zanData.splice(that.delIndex,1)
