    ...
    <div class="wrapper">
        <div class="minibar">
            ...
            >
                ...
                <text :style="GLOBAL.headerCenter"  slot="middle">系统通知</text>
                <!--<text :style="GLOBAL.headerRight"  slot="right">帮助</text>-->
            </wxc-minibar>
        </div>
        <scroller class="scroller" offset-accuracy="10" @scroll="scrollHandler">
            <div class="masks" v-for="(item,index) in sysData" @touchstart="ontouchstart(item.id,index)" @touchend="ontouchend">
                <div>
                ...
                <div class="right">
                    <div style="flex-direction: row;justify-content: space-between;align-items: center;width: 550px;">
                        <div>
                            <text class="userName" :style="{fontSize:GLOBAL.biggerFS,color:GLOBAL.tColor}">系统信息</text>
                        </div>
                        <div>
        ...
        <wxc-mask height="322"
            ...
            <div class="mask" @click.stop="">
                ...
                <text class="maskContent">确定删除此系统通知消息？</text>
...
<script>
    ...
    var timer = null;
    export default {
        components: {WxcMinibar, WxcButton,WxcMask,Toast},
        data() {
            return {
        ...
        created:function() {
            ...
            post.fetch({
                ...
                if (e.data.res === -2) {
                    ...
                    var sysData = e.data.data;
                    that.page += sysData.length;
                    if (sysData.length !== 10) {
                        that.loadingingType = 0;
                    }
                    that.sysData = that.sysData.concat(sysData);
        ...
        methods:{
            ...
            commentDelect(){
                ...
                post.fetch({
                    ...
                    if(e.data.res === 1) {
                        that.sysData.splice(that.delIndex,1)
