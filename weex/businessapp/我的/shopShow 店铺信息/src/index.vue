    ...
    <div class="wrapper" @viewappear="viewappear" @viewdisappear="viewdisappear" :style="{visibility: visibility}">
        ...
        <div class="header">
            ...
            <div class="allSave ">
                ...
                <image class="icon_star" :src="shopInfo.colType==1?'https://image.aftdc.com/images/icon_starCollage.png':'https://image.aftdc.com/images/icon_starUnCollage.png'" ></image>
                <image class="icon_ping" src="https://image.aftdc.com/appBimg/ic_pingdan.png"  v-if="(orderType==0||orderType==5)&&distance < shopInfo.range&&closeButton&&!shareOrder"></image>
            ...
            <div>
                <div class="topBody" >
                    ...
                    <div class="topBody-right">
                        <text class=" btnFocus" :class="[shopInfo.attentionType==1?'attentionGreen':'attentionRed']" >{{shopInfo.attentionType==1?'已关注':'关注'}}</text>
                ...
                <scroller show-scrollbar="false" style="flex: 1" >
                    <scroller v-if="orderRedPackets" scroll-direction="horizontal" class="redPackets_scroller" show-scrollbar="false" >
                        <div class="redPackets_small" ref="redPackets_small">
                            <div  v-for="(item,index) in redPackets" class="couponDiv" >
                    ...
                    <div @touchstart="ontouchstart($event,2)" @touchmove="ontouchmove($event,2)" @touchend="ontouchend($event,2)" fireEventSync="true">
                        <scroller style="width: 750px;position: relative"  @scroll="scrollHandler($event,2)">
                            ...
                            <div v-if="pingLunShow.length>0">
                                <div class="pinLun_topStyle"  v-for="(item,index) in pingLunShow" >
                                    <div class="pinLun_bottomStyle" >
                                        ...
                                        <div class="pinLun_zan">
                                            ...
                                            <div class="aiCenter">
                                                ...
                                                <div class="zanDiv" style="margin-left: 20px">
        ...
        <div class="shopCar" @click="shopCarShowClick()" v-if="tabIndex==0&&topDetails">
            ...
            <div v-if="shareOrder">
                ...
                <text class="order" v-else-if="shopCar" :style="{fontSize:GLOBAL.defaultFS}">选好了</text>
            </div>
            <!--外卖按钮  -->
            <div v-else-if="orderType==0&&closeButton">
                ...
                <div v-else>
                    ...
                    <text class="order" v-else-if="shopCar"  :style="{fontSize:GLOBAL.defaultFS}">下单</text>
                </div>
            </div>
            <!--到店自取按钮  -->
            ...
            <div v-else-if="orderType==3&&closeButton">
                ...
                <text class="order" v-else-if="shopCar"  :style="{fontSize:GLOBAL.defaultFS}">填写预订信息</text>
            </div>
            <!--团购代金券按钮  -->
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            that.longitude = JSON.parse(weex.config.param).longitude;
            that.latitude = JSON.parse(weex.config.param).latitude;
