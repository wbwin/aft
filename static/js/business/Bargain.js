        ...
        location.href = "/business/Login/index.html";
            ...
            var app = new Vue({
                ...
                created: function () {
                    ...
                    axios({
                        method: "post",
                        url: 'https://www.aftdc.com/Business/Activity/getFoods',
                        ...
                        if (res.data.res == 1) {
                            ...
                            if (Boolean(res.data.data.discount)) {
                                ...
                                console.log(that.discountGoods);
                            }
                ...
                methods: {
                    ...
                    pplianshchClick: function () {
                        if ($('input[name="ener"]').is(':checked')) {
                            ...
                            if (confirm('是否删除')) {
                                ...
                                axios({
                                    method: "post",
                                    url: 'https://www.aftdc.com/Business/Activity/delBargainGoods',
                                    data:
                                        {
                                            id: jsonId,
                                            token: shopData.token
                    ...
                    saveClick: function (type) {
                        ...
                        axios({
                            method: "post",
                            url: 'https://www.aftdc.com/Business/Activity/setBargain',  // 后台请求
                            data: {
                    ...
                    Fuck_baoClick: function () {
                        var that = this;
                        var Kanjiamin = $("#Kanjiamin").val();
                        if (Kanjiamin == "") {
                            alert("价格不能为空!!!");
                            return false;
                        }
                        var pattern = /(^[1-9]([0-9]+)?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/;
                        if (!pattern.test(Kanjiamin)) {
                            alert("请输入正确的价格!!!");
                            return false;
                        }
                        ...
                        axios({
                            method: "post",
                            url: 'https://www.aftdc.com/Business/Activity/argain',
                            data: {
                                startTime: Lzhi,
                                endTime: Rzhi,
                                disId: disId,
                            ...
                            console.log(res);
                            if (res == null || res.data == null || res.data.res == null) {
                                alert("保存成功")
                                $(".ThisToallys").hide();
                                return false;
                            }
                                ...
                                for (var i = 0; i < discountId.length; i++) {
                                    for (var k = 0; k < discountGoods.length; k++) {
                                        ...
                                        if (discountGoods[k]['id'] == discountId[i]) {
                                            that.$set(discountGoods[k], 'minPrice', minPrice);
