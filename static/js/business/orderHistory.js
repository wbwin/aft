window.onload = function() {
    ...
    if (!shopData) {
        ...
        var evaluate = new Vue({
            ...
            data: {
                radios: [
                    {val: '支付类型', choice: ['全部', '在线支付', '货到付款'], sele: '全部'},
                    {val: '订单状态', choice: ['全部', '有效订单', '无效订单'], sele: '全部'},
                    {val: '订单排序', choice: ['订单序号', '下单时间'], sele: '订单序号'},
                ],
                time: {start: '', end: '', name: ''},
                ...
                orderData: [
                    /*{
                            ...
                            seleTime:'立即送达',
                            phone:'13838384384',
                            userAddress:'地中海国际酒店 (4588)',
                            distance :'3.3',//km
                            dirverPhone:'',
                            driverName:'',

                            goods:[{
                                 goodsName:'周瑜酿皮 （小份）（中辣）',
                                 goodsPrice:'12.00',
                                 goodsNumb:1,
                            },{
                                 goodsName:'香辣牛筋面 （大份）（中辣）',
                                 goodsPrice:'16.00',
                                 goodsNumb:1,
                            }],
                            boxF:'2.00',//餐盒费
                            activity:'6.00',//活动支出  还有详细数据
                            terrace:'5.00', //平台服务费   还有详细数据

                            factPrice:'19.00',//顾客实付
                            orderNo :'1245',//订单编号
                        },
        */
                ],
            ...
            created: function () {
                ...
                //获取数据
                that.phone = sessionStorage.getItem("phoneOrder");
            ...
            methods: {
                pageFn: function (pageCurent) {
                    ...
                    if (phone != null) {
                        var url = 'https://www.aftdc.com/Business/Ordersa/history';
                        var data = {
                            page: page,
                            phone: phone,
                        }
                    } else {
                        var url = 'https://www.aftdc.com/Business/Ordersa/getHistoryOrder';
                        var data = {
                            page: page,
                            start: that.start,
                            end: that.end,
                ...
                changeRadio: function (e) {
                    ...
                    var end = that.end;//单选框
                    that.jsonStr = JSON.stringify(seles);
                    axios({
                        method: "post",
                        url: 'https://www.aftdc.com/Business/Ordersa/getHistoryOrder',
                        data: {
                            page: 0,
                            start: start,
                            end: end,
                        ...
                        // var aa=new Object(res.orderData[0].goods[0])
                        //                                  console.log(aa)
