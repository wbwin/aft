...
var evaluate = new Vue({
    ...
    methods: {
        ...
        formSubmit: function() {
            ...
            axios({
                methods: "post",
                url: '/index.php/Business/Branch/detailed',
                data: formData,
            }).then(function(res) {
                console.log(res)
                if (res.res == 1) {
                        ...
                        axios({
                            ...
                            if (unm == five) {
                                if (ok == 1) {
                                    ...
                                    window.parent.location.hash = "#/Branch/scheme/1"
