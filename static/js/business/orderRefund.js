        ...
        var evaluate = new Vue({
            ...
            methods: {
                ...
                pageFn: function (pageCurent) {
                    ...
                    axios({
                        method: "post",
                        url: 'https://www.aftdc.com/Business/Ordersa/getRefundOrder',
                        async: false,
                        data: {
                            page: page,
                ...
                changeRadio: function (e) {
                    ...
                    axios({
                        ...
                        that.orderData = orderData
                        // that.shopId = that.orderData[0].shopId
                        //初始化页数
                        var pageCount = Number(res.data.pageCount);
                        var pageEach = Number(res.data.pageEach);
                        that.pageEach = res.data.pageEach;
                ...
                refund: function (orderId) {
                    ...
                    axios({
                        method: "post",
                        url: 'https://www.aftdc.com/Business/Ordersa/aRefund',
                        data: {
                            orderId: orderId,
                            token: shopData.token,
                ...
                norefund: function (orderId) {
                    var that = this
                    axios({
                        method: "post",
                        url: 'https://www.aftdc.com/Business/Ordersa/bRefund',
                        data: {
                            orderId: orderId,
                            token: shopData.token,
