...
$.fn.dateSelect = function(evaluate) {
	...
	var settings = $.extend({}, date_config);
...
//  	}    	
    ...
    //选择天
	 ...
	 $("#datepicker_" + elem_id +" .day").off("click","li")
...
//------------------------------------------------------------------------------------------------------------------------------------
    ...
    var index=$(obj).attr("data-index");
     if(index=="not"||isNaN(index)){
        //单个时间
        evaluate.date=date_sel
        evaluate.timeFn()
     }else{
         evaluate.$set(evaluate.infoData[index],"val",date_sel);
        evaluate.timeFn(index)
     }
...
//------------------------------------------------------------------------------------------------------------------------  --------	
    ...
    {	
        ...
        var wih=$("#datepicker_" + elem_id +" .day li").first().width()//30
    	$("#datepicker_" + elem_id +" .day li").first().css({"margin-left":wih*dayOfWeek});
    }
